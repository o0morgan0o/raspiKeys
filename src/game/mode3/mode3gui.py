...
class Mode3:
    def __init__(self, globalRoot, gameFrame, config, app):
        ...
        self.gameFrame.btnRandomLick = BtnBlack10(self.gameFrame, text="Practise All")
    ...
    def placeElements(self):
        ...
        self.gameFrame.btnPractiseLick.place(x=10, y=yplacement, width=140, height=80)
        self.gameFrame.btnRandomLick.place(x=170, y=yplacement, width=140, height=80)

        yplacement += 90
        self.gameFrame.btnDeleteSelected.place(x=10, y=yplacement, width=300, height=40)
