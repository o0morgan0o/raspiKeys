...
class CTkButton(tkinter.Frame):
    ...
    def __init__(self,
        ...
        self.asked_corner_radius = corner_radius
        self.corner_radius = self.calculateCornerRadius(self.asked_corner_radius)
    ...
    def calculateCornerRadius(self, asked_corner_radius):
        if asked_corner_radius * 2 > self.height:
            corner_radius = self.height / 2
        elif asked_corner_radius * 2 > self.width:
            corner_radius = self.width / 2
        else:
            corner_radius = asked_corner_radius
