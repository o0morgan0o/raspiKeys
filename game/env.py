...
ROOT_DIR = os.getcwd()
TEST_ROOT_DIR_PROCESSED_WAV_FOLDER = os.path.join(
    ROOT_DIR, "res_test", "processed_wav")
TEST_ROOT_DIR_PROCESSED_EMPTY_FOLDER = os.path.join(
    ROOT_DIR, "res_test", "processed_wav_empty")
print("ROOT :::", ROOT_DIR)
...
PROCESSED_WAV_FOLDER = os.path.join(
    ROOT_DIR, "res", "backtracks", "processed_wav")
...
MODE0_IMAGE_BLACK = os.path.join(
    ROOT_DIR, "res", "icons", "earTrainingNoteBlack.png")
MODE1_IMAGE_BLACK = os.path.join(
    ROOT_DIR, "res", "icons", "earTrainingChordBlack.png")
...
MODE0_IMAGE_WHITE = os.path.join(
    ROOT_DIR, "res", "icons", "earTrainingNoteWhite.png")
MODE1_IMAGE_WHITE = os.path.join(
    ROOT_DIR, "res", "icons", "earTrainingChordWhite.png")
