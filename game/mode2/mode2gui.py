...
class Mode2:
    def __init__(self, globalRoot, gameFrame, config, app):
        ...
        self.gameFrame.labelCurrent = MyLabel10(
            self.gameFrame, text="", wraplength=300)
        self.gameFrame.labelCurrent.config(
            background="white", foreground="black")
        self.gameFrame.btnLick = BtnBlack20(
            self.gameFrame, text="Record Lick on this drumLoop", wraplength="280")
    ...
    def placeElements(self):
        ...
        yplacement += 80
        self.gameFrame.canvas.place(x=0, y=yplacement, width=340, height=10)
        yplacement += 20
        ...
        self.gameFrame.btnRandom.place(
